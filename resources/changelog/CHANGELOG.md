...
* FLUX-791 - form-control - submit op Enter werkt ook met het numerieke klavier ([bbf991f](https://github.com/milieuinfo/flux-web-components/commit/bbf991fccc108b2d1f651cacec7f06fd6b40122e))
* FLUX-794 - vl-upload - aria-invalid en gekende toegankelijkheidsbeperking ([2373023](https://github.com/milieuinfo/flux-web-components/commit/237302380b4fe8179bbfab6825fffd3fc78a6071))
* FLUX-795 - Critical dependency waarschuwingen van cypress-axe onderdrukt ([b62fbe3](https://github.com/milieuinfo/flux-web-components/commit/b62fbe3726b83ba97a855adc85468966766d9e03)), closes [component-driven/cypress-axe#99](https://github.com/component-driven/cypress-axe/issues/99)
* FLUX-796 - vl-side-navigation-next - auto-sectie rescan bij slotchange verbeterd ([5710cb7](https://github.com/milieuinfo/flux-web-components/commit/5710cb7574f785f307c1fe2d4395c29ad543dd30))
* FLUX-800 - vl-breadcrumb-item - focus outline enkel bij toetsenbordnavigatie ([89c0f66](https://github.com/milieuinfo/flux-web-components/commit/89c0f660957a268146d912bd0c60a4ede389d6a0))
* FLUX-810 - vl-side-sheet, vl-cascader - focus management bij open side-sheet hersteld ([d68ff04](https://github.com/milieuinfo/flux-web-components/commit/d68ff04f1d89c359158134c55711db577f3c7b7e))
* FLUX-811 - vl-cascader - pijltje rechts bij link in label-slot ([6854ffc](https://github.com/milieuinfo/flux-web-components/commit/6854ffc2a5f6ef66bc5c04826fa3fc391b93ca0e))

### Features

* FLUX-708 - migratie van npm naar pnpm ([6899016](https://github.com/milieuinfo/flux-web-components/commit/68990169ee82a23f101fb4bcc8d653462979329a))
* FLUX-800 - vl-breadcrumb - ellipsis attribuut voor lange breadcrumb items ([9311ae6](https://github.com/milieuinfo/flux-web-components/commit/9311ae68d254eedde4b391423e46232b07a0a105))
* FLUX-800 - vl-cascader - breadcrumb opgebouwd met vl-breadcrumb en WCAG verbeteringen ([c04a72c](https://github.com/milieuinfo/flux-web-components/commit/c04a72c73281b6b0729196ef9ebbb279c70ea03f))
* FLUX-809 - vl-alert - banner variant ([f2a3414](https://github.com/milieuinfo/flux-web-components/commit/f2a3414d4c662728800182c3e87d61030ebb53ed))

### Documentation

* documentatie van de lokale npm registry configuratie ([a6116b6](https://github.com/milieuinfo/flux-web-components/commit/a6116b63600a29dcff322480c4f605969078214c))
* FLUX-708 - recept 'Van npm naar pnpm' voor afnemers ([4d555a6](https://github.com/milieuinfo/flux-web-components/commit/4d555a630d56bb0f838aca5c6429cd1a08dfc3f3))
* FLUX-776 - Flux-AI - analyse herwerkt naar de nieuwe AI-strategie ([b479b90](https://github.com/milieuinfo/flux-web-components/commit/b479b90d3d180877962883d319d64c2ff6b7b708))
* FLUX-776 - Flux-AI - Frontend Uniformisering via AI ([f18485b](https://github.com/milieuinfo/flux-web-components/commit/f18485be3b7b7b7f95767d0c10f95b069d996bc0))
* FLUX-787 - blur-validatie - beschrijving ingekort en documentatiepagina rechtgezet ([293c741](https://github.com/milieuinfo/flux-web-components/commit/293c741d39821ea2091db2bf1e274dcc15e1c71a))
* FLUX-802 - componenten overzicht - WCAG status ([782a93c](https://github.com/milieuinfo/flux-web-components/commit/782a93c38379dfd7a3d46627c7660c619fab0dcd))
* planning 2026 toegevoegd aan historiek & toekomst ([63a4c95](https://github.com/milieuinfo/flux-web-components/commit/63a4c954ef0ed87a856cdb3fabc54d432fe5c1be))

# [2.19.0](https://github.com/milieuinfo/flux-web-components/compare/v2.18.0...v2.19.0) (2026-08-25)

### Bug Fixes

* FLUX-207 - vl-toaster - showAlert verwacht de attribuutnamen ([ca607d5](https://github.com/milieuinfo/flux-web-components/commit/ca607d565952487b67e70bb26f0fe67bd076b7f3))
* FLUX-213 - vl-link - screenreader melding bij externe links ([6139351](https://github.com/milieuinfo/flux-web-components/commit/613935152f703f3768248a7149572813a288f229))
* FLUX-219 - vl-description-data - label/waarde als description list ([0ee6e57](https://github.com/milieuinfo/flux-web-components/commit/0ee6e57fdf2069646fd8ef87c7c5c25fbe123afb))
* FLUX-236 - vl-http-error-message - debug-info als definitielijst en verwijzing naar adresbalk ([53040a9](https://github.com/milieuinfo/flux-web-components/commit/53040a9aae01156bfb9a62a4bbbcf4e58a9b9b54))
* FLUX-471 - skip-link - ver genoeg scrollen bij sticky header ([19f3b89](https://github.com/milieuinfo/flux-web-components/commit/19f3b89de2700e5959a148ba8178cab4897975d3))
* FLUX-760 - vl-properties - whitespace tussen properties binnen een column ([9d28af3](https://github.com/milieuinfo/flux-web-components/commit/9d28af3f95800ee364c83110f6b5ec1cf2ac9fd1))
* FLUX-780 - vl-progress-indicator - laatste stap valt niet meer buiten de rand ([e1b195c](https://github.com/milieuinfo/flux-web-components/commit/e1b195c0d8db6ad6e60700f85059fae7e66321e2))
* FLUX-784 - vl-progress-indicator - verbindingslijnen tussen de stappen hersteld ([cfe65f3](https://github.com/milieuinfo/flux-web-components/commit/cfe65f3db500990b19f7cbe91b876519f0c57c10))
* FLUX-788 - vl-header-next / vl-footer-next - flaky testen en ready-event ([778158e](https://github.com/milieuinfo/flux-web-components/commit/778158e2b32c35111560744b7529ff6681ee0101))
* FLUX-790 - storybook - de changelog feats hadden de fixes style ([7bbb00d](https://github.com/milieuinfo/flux-web-components/commit/7bbb00dc29624b0c433acd4aa98b3ed0fc8ade4f))

### Features

* FLUX-207 - vl-alert - instelbare ARIA-rol per context ([8ec5138](https://github.com/milieuinfo/flux-web-components/commit/8ec5138d54a8680bbf5d4c93f7f72c328c357b27))
* FLUX-471 - vl-header, vl-header-next - skip-to-content link (WCAG 2.4.1) ([03eff7a](https://github.com/milieuinfo/flux-web-components/commit/03eff7a02dd37ccb214e1966c7824e1133f39df9))
* FLUX-610 - cross-validatie - dependencySelectors via CrossValidationMixin met voorbeelden en docs ([2f7dc51](https://github.com/milieuinfo/flux-web-components/commit/2f7dc5151d001bf9d9f51f820dc28533332bd95f))
* FLUX-658 - CompositeFormControl - basisklasse voor samengestelde velden ([8a0bb40](https://github.com/milieuinfo/flux-web-components/commit/8a0bb4053fc6488faed6b2bc7857db6ad43e2a44))
* FLUX-757 - vl-properties - value-bold attribuut toegevoegd ([d45b5e1](https://github.com/milieuinfo/flux-web-components/commit/d45b5e131b31ab792993c136083b6a7ca26fc4f4))
* FLUX-773 - vl-select-rich - itemTemplate voor eigen optie-inhoud ([995a202](https://github.com/milieuinfo/flux-web-components/commit/995a202e125b78421bdd1f5e7bbe075c6a297f05))
* FLUX-782 - vl-autocomplete - itemTemplate property toegevoegd ([cfd208b](https://github.com/milieuinfo/flux-web-components/commit/cfd208b9fd6d6e9f048365f5b391219b4eb16656))
...
* FLUX-643 - Jenkins build - ci-bamboo naar ci-jenkins, Bamboo build verwijderd ([77edaf7](https://github.com/milieuinfo/flux-web-components/commit/77edaf74ac2b5df02e6e18da6b3326b06370477b))
* FLUX-643 - Jenkins build - doorlooptijd versneld door parallellisatie ([8f5edd2](https://github.com/milieuinfo/flux-web-components/commit/8f5edd2bebd063538c35ceb59a994d3db89bab3c))
* FLUX-643 - Jenkins build - initiële opzet ([17bbac2](https://github.com/milieuinfo/flux-web-components/commit/17bbac24eca533a880c3ea10afabb219ca013c1e))
* FLUX-643 - Jenkins build - Jenkinsfile.groovy verbeteringen ([2d45277](https://github.com/milieuinfo/flux-web-components/commit/2d4527781adcdaeb26dffe3a699900135aaefbbb))
* FLUX-643 - Jenkins build - publicatie van de Cypress testresultaten in Jenkins ([2ecd23f](https://github.com/milieuinfo/flux-web-components/commit/2ecd23fa8e9bbc1c0f3b55325deb9f02c40cfaa6))
...
* FLUX-475 - vl-map-layer-switcher - alle dynamisch toegevoegde kaartlagen correct tonen ([84ad38c](https://github.com/milieuinfo/flux-web-components/commit/84ad38c098be5315458cfd77da7aa27ac8c3fc04))
* FLUX-512 - vl-upload - opladen van meerdere bestanden ([4c7e229](https://github.com/milieuinfo/flux-web-components/commit/4c7e22958f94f67d3c0acaca2a7131c591c7c1fc))
* FLUX-537 - vl-alert - multiline support verbeterd ([360ce29](https://github.com/milieuinfo/flux-web-components/commit/360ce29564f74783283afdb20a49cb03ae7bde7e))
* FLUX-545 - onderhoud - lit imports en runtime alignment ([b17fb74](https://github.com/milieuinfo/flux-web-components/commit/b17fb74880e9b4842bc6c07b784bfbea80373c42))
* FLUX-552 - vl-side-navigation-next - styling gestroomlijnd ([64e0056](https://github.com/milieuinfo/flux-web-components/commit/64e0056f4808d3878a630f3d693072bc0f77e346))
* FLUX-571 - z-index aangepast voor info-tile menu ([1d487e6](https://github.com/milieuinfo/flux-web-components/commit/1d487e677480f36398038088a3277f5aae400624))


### Features

* FLUX - vl-form-message - storybook verbeterd ([9ad5c2e](https://github.com/milieuinfo/flux-web-components/commit/9ad5c2e90a630d479a2964ca560c59f135cd9238))
* FLUX-238 - vl-info-tile - WCAG verbeteringen ([eb06ece](https://github.com/milieuinfo/flux-web-components/commit/eb06ecedf388b52985379b389c3e1cde77e29f2c))
* FLUX-269 - vl-rich-data - WCAG verbeteringen ([79fd238](https://github.com/milieuinfo/flux-web-components/commit/79fd238dd56748f7876d388f35480044a6c65e4f))
* FLUX-269 - vl-rich-data-table - WCAG verbeteringen ([bf8f065](https://github.com/milieuinfo/flux-web-components/commit/bf8f065dd7817cab76718104ad9993f9e23bde02))
* FLUX-269 - vl-table - expandable - WCAG verbeteringen ([07647bb](https://github.com/milieuinfo/flux-web-components/commit/07647bb7c43953737c2c72b904ce092ab29a418e))
* FLUX-279 - vl-side-navigation-next - WCAG - focus behandeling verbeterd wanneer die verdwijnt tijdens scroll ([ad4eb5f](https://github.com/milieuinfo/flux-web-components/commit/ad4eb5f024adb2df857ce89a81a213646a53fa4e))
* FLUX-306 - z-index attribuut toegevoegd aan VlMapLayer ([f9ecc3c](https://github.com/milieuinfo/flux-web-components/commit/f9ecc3ca461fba66dc0d3d38c3903b7fc8466392))
* FLUX-307 - vl-map - pattern attribuut op de laag en legende ([b9942f2](https://github.com/milieuinfo/flux-web-components/commit/b9942f268b37a3d43edd52b2c294fb6ca76fa628))
* FLUX-317 - vl-rich-data-table - enkel column-gap wanneer filter zichtbaar is ([43b20de](https://github.com/milieuinfo/flux-web-components/commit/43b20dedc3c4063e89ecd0e5c6414fab9f58a7c3))
* FLUX-335 - vl-description-data - size's op het item krijgen voorrang ([991d46a](https://github.com/milieuinfo/flux-web-components/commit/991d46a712c62f20991c0e52b3de779aa228ac47))
* FLUX-390 - vl-spotlight, vl-infotext, vl-doormat - link-label & external toegevoegd ([4709e78](https://github.com/milieuinfo/flux-web-components/commit/4709e780c3c90605a2abaf6213eca02a9ddad000))
* FLUX-391 - titel met annotatie als patroon ([d94d9de](https://github.com/milieuinfo/flux-web-components/commit/d94d9de190457e3577e13919e42f5823d1fb76ac))
* FLUX-476 - vl-rich-data-table - gedrag van "select all" verbeterd ([2f02b6c](https://github.com/milieuinfo/flux-web-components/commit/2f02b6cd828ad80b7d4311e21fa9c0cf9b326e4d))
* FLUX-482 - vl-privacy - genest grid omgezet naar vl-stacked ([bbbacb8](https://github.com/milieuinfo/flux-web-components/commit/bbbacb8b19211ac1ddb8fb63ebc27079f1099b6f))
* FLUX-482 - vl-stacked - introductie van losstaande 'vl-stacked' ([6ff59e3](https://github.com/milieuinfo/flux-web-components/commit/6ff59e3dcc5bdf55bea154f9c60fe6720984b4e9))
* FLUX-490 - vl-info-tile - aanpasbare background-color van het icon ([a3cdd08](https://github.com/milieuinfo/flux-web-components/commit/a3cdd08bb761cc0164612b655933666e3b518cd8))
* FLUX-509 - vl-map-wmts-layer - TileMatrix uit de capabilities halen ([135d415](https://github.com/milieuinfo/flux-web-components/commit/135d41595d998e5bffe5ba2153c41622e23718bd))
* FLUX-521 - vl-upload - getRejectedFiles() toegevoegd ([431d7a4](https://github.com/milieuinfo/flux-web-components/commit/431d7a464553f0eb3c44a7b7fdf6dcbcf6cd8388))
* FLUX-541 - vl-side-navigation-layout-next - vl-side-navigation-layout hernoemd naar vl-side-navigation-layout-next ([b6b75e0](https://github.com/milieuinfo/flux-web-components/commit/b6b75e06cc719f279ce8fe89aee9eae9e01bef8c))
* FLUX-541 - vl-side-navigation-next - ondersteuning proza-message toegevoegd ([071ea59](https://github.com/milieuinfo/flux-web-components/commit/071ea59c77a901a44b3105ba0f7eb8c2949e82a4))
* FLUX-553 - npm package versies verhoogd ([e961cfd](https://github.com/milieuinfo/flux-web-components/commit/e961cfd859624088f04cf479f9aa9c45634940f7))
* FLUX-553 - ongebruikte npm dependencies verwijderd ([e81b13b](https://github.com/milieuinfo/flux-web-components/commit/e81b13b552464c04f69d9a8a8f9899a52be6b7be))
* FLUX-568 - migratie faq uitgebreid ([6329fba](https://github.com/milieuinfo/flux-web-components/commit/6329fba722a252b51d698e87e7667dc85e012dcb))
* FLUX-568 - vl-tooltip - migratie impact gedocumenteerd ([bd255ce](https://github.com/milieuinfo/flux-web-components/commit/bd255ce6fe47c84d0fcad639b382d0bf49654a7a))
* FLUX-570 - patronen ipv ontwerp (Storybook herwerking) ([52c5ff6](https://github.com/milieuinfo/flux-web-components/commit/52c5ff6db53983bd16c9d3b1df778d9e87f0f3f2))
...
* Storybook toonde de oude changelog ([433bf33](https://github.com/milieuinfo/uigov-web-components/commit/433bf3394a49678f93b492efd95a607f2fbfb0c2))
...
* de lib.js bestanden zaten niet meer in de artifacts ([3067e8b](https://github.com/milieuinfo/uigov-web-components/commit/3067e8b6aa641b45890ccf05ed4b032cc262ed22))
