 ...
 * hieruit, zodat er maar één mapping bestaat. Ze importeren hem via `../group/vl-group-modifier`: de catalogus-sync
 * in flux-mcp neemt enkel relatieve imports mee die met `../` beginnen.
 *
