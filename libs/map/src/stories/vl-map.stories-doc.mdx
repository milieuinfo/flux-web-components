...
<FluxComponentMetaData id="map-components-map" />
...
Vereist je project Lambert 72 coördinaten bij het intekenen, dan wordt het upgraden naar de Lambert 2008 kaart
