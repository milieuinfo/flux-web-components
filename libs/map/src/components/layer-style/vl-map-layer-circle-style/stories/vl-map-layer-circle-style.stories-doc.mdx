...
<FluxComponentMetaData id="map-components-layer-style-layer-circle-style" />
...
Per verhoogde machtsverheffing wordt die coëfficiënt verhoogd met 1.
    - meer dan 10 features: `size` x 2
    - meer dan 100 features: `size` x 3
    - meer dan 1000 features: `size` x 4
    - enzovoort..

Het is ook mogelijk te kiezen de verhouding van de coëfficiënt aan te passen door de `cluster-multiplier` in
te stellen.
