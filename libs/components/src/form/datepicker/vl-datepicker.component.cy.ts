...
import { getFormMessageTextPart } from '../form-message/vl-form-message.component.cy';
...
describe('component - vl-datepicker - in form', () => {
    ...
    it('should validate date pattern by default', () => {
        ...
        getFormMessageTextPart(cy.get('vl-form-message[state="valueMissing"]')).should('not.be.visible');
        getFormMessageTextPart(cy.get('vl-form-message[state="patternMismatch"]')).should('be.visible');
        cy.get('vl-form-message[state="patternMismatch"]').should(
            'have.text',
        ...
        cy.get('button[type="submit"]').click();
        getFormMessageTextPart(cy.get('vl-form-message[state="patternMismatch"]')).should('not.be.visible');
        cy.checkA11y('vl-datepicker');
    });
