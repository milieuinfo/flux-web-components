...
<FluxComponentMetaData id="components-form-input-group"/>
...
[Group](/docs/styles-layout-group--documentatie), [Button](/docs/components-atom-button--documentatie)
en [Input Field](/docs/components-form-input-field--documentatie) kunnen in de juiste toestand gebracht worden om
