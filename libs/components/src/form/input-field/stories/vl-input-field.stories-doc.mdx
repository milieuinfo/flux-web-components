...
- `date`: [vl-datepicker](/docs/form-datepicker--documentatie)
- `file`: [vl-upload](/docs/form-upload--documentatie)
- `checkbox`: [vl-checkbox](/docs/form-checkbox--documentatie)
- `radio-group`: [vl-radio-group](/docs/form-radio-group--documentatie)
...
Voor mask validatie kan je gebruik maken van de [vl-input-field-masked](/docs/form-input-field-masked--documentatie) component.
