...
> Opgelet: je kan pas events registreren nadat de component geïnitialiseerd is met behulp van het `vl-initialised`-event
...
[Documentatie Digitaal Vlaanderen - Upload](https://www.vlaanderen.be/vlaanderen-design-system/componenten/upload)
