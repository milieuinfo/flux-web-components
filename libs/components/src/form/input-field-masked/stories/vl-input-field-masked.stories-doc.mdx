...
<FluxComponentMetaData id="components-form-input-field-masked" />


## Doel

Gebruik de `input-field-masked` component om een input veld met een mask toe te voegen aan een pagina.<br/>
...
<Canvas of={VlInputFieldMaskedStories.InputFieldMaskedCustom} />
