...
describe('component - vl-checkbox - in form', () => {
    ...
    it('should validate', () => {
        ...
        getFormMessageTextPart(cy.get('vl-form-message[for="confirmation"]')).should('not.be.visible');
        cy.get('button[type="submit"]').click();
        getFormMessageTextPart(cy.get('vl-form-message[for="confirmation"]')).should('be.visible');
