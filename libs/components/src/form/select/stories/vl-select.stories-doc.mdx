...
Dit component is volledig accessible, we raden aan waar mogelijk gebruik te maken van dit component in plaats van de [vl-select-rich](/docs/form-select-rich--documentatie).<br/>
