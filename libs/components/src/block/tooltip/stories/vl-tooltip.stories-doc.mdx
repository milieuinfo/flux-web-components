...
Om te vermijden dat de tooltip gepositioneerd wordt tegenover het verkeerde element, kan je best de eerste parent van de tooltip instellen op `position: relative` zodat de tooltip steeds gepositioneerd wordt zoals verwacht.
