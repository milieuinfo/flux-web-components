...
<FluxMetaData id="components-block-steps-steps" />

Gebruik de `steps` component om een verticale lijst van stappen af te beelden om de gebruiker door een procedure te begeleiden.<br/>
