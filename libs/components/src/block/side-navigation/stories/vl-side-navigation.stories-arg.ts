...
export const sideNavigationArgTypes: ArgTypes<typeof sideNavigationArgs> = {
    ...
    hashSync: {
        name: 'hash-sync',
        description: `Attribute wordt gebruikt om aan te duiden dat de url hash gesynchroniseerd moet worden 
met de side navigation. Dit gebeurt in twee richtingen: enerzijds, indien er een hash aanwezig in de url die 
