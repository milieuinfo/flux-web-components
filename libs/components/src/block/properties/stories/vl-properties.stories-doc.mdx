...
<FluxComponentMetaData id="components-block-properties" />
...
afgedwongen worden via de `stacked` class (`stacked` vervangt de deprecated class `collapsed`).

<Canvas of={VlPropertiesStories.PropertiesStacked}/>
...
[Properties](https://www.vlaanderen.be/vlaanderen-design-system/componenten/properties)
