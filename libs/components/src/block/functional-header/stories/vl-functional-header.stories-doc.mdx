...
### Met extra button of search component

Zie [Ontwerp/Functional Header](/docs/ontwerp-functional-header-voorbeeld-met-button--documentatie) voor voorbeelden van functional headers met een extra button of search component.
