...
- Vermijd het gebruik van `history.back()`. De gebruiker kan op verschillende manieren op je pagina beland zijn.
...
[Documentatie Digitaal Vlaanderen - Functional Header](https://www.vlaanderen.be/vlaanderen-design-system/componenten/application-header)
