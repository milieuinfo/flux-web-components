...
<FluxComponentMetaData id="components-block-toaster" />
...
[Documentatie Digitaal Vlaanderen - Toaster](https://www.vlaanderen.be/vlaanderen-design-system/componenten/toaster)
