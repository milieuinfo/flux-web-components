...
<VluxMetaData id="components-next-table" />
...
```js
import { VlTableComponent } from '@domg-wc/components/next/table';
```
...
[rich-table](?path=/docs/components-rich-table--rich-table-default) beschikbaar.<br/>
...
[Documentatie Digitaal Vlaanderen - Data Table](https://overheid.vlaanderen.be/webuniversum/v3/documentation/components/vl-ui-data-table)
