...
describe('component - vl-table-next', () => {
    it('should mount', () => {
        mountDefault({});

        cy.get('vl-table-next').find('table').should('have.class', 'vl-table-next');
    });
            ...
            .each((row) => {
                if (!row.attr('data-details-id')) {
                    cy.wrap(row)
                        .children()
                        .each((cell, cellIndex) => {
                            if (!cell.children('vl-button-next').length) {
    ...
    it('should contain a table with hover styling', () => {
        ...
        cy.get('vl-table-next')
            .find('table')
            .should('have.class', 'vl-table-next')
            .should('have.class', 'vl-table-next--hover');
    });
    ...
    it('should contain a table with a matrix', () => {
        ...
        cy.get('vl-table-next')
            .find('table')
            .should('have.class', 'vl-table-next')
            .should('have.class', 'vl-table-next--matrix');
    });
    ...
    it('should contain a table with a grid', () => {
        ...
        cy.get('vl-table-next')
            .find('table')
            .should('have.class', 'vl-table-next')
            .should('have.class', 'vl-table-next--grid');
    });
    ...
    it('should contain a table with a zebra grid', () => {
        ...
        cy.get('vl-table-next')
            .find('table')
            .should('have.class', 'vl-table-next')
            .should('have.class', 'vl-table-next--zebra');
    });
    ...
    it('should contain a table that collapsed on the medium breakpoint', () => {
        ...
        cy.get('vl-table-next')
            .find('table')
            .should('have.class', 'vl-table-next')
            .should('have.class', 'vl-table-next--collapsed-m');
    });
    ...
    it('should contain a table that collapsed on the small breakpoint', () => {
        ...
        cy.get('vl-table-next')
            .find('table')
            .should('have.class', 'vl-table-next')
            .should('have.class', 'vl-table-next--collapsed-s');
    });
    ...
    it('should contain a table that collapsed on the extra small breakpoint', () => {
        ...
        cy.get('vl-table-next')
            .find('table')
            .should('have.class', 'vl-table-next')
            .should('have.class', 'vl-table-next--collapsed-xs');
    });
});
...
describe('component - vl-table-next - expandable', () => {
    it('should mount', () => {
        mountExpandable({});
                ...
                cy.wrap(row)
                    ...
                    .each((cell, cellIndex) => {
                        if (!cell.children('vl-button-next').length) {
                            ...
                            cy.wrap(cell).find('vl-button-next');
                        }
                    });
                cy.wrap(row)
                    .next()
...
describe('component - vl-table-next - expandable with custom button', () => {
    it('should mount', () => {
