...
<VluxMetaData id="components-next-button" />
...
button. Bij voorkeur wordt de `vl-button-next` gebruikt om een actie uit te voeren en de `vl-link-next` om
...
attribuut doet enkel iets in die combinatie. Zie [Input Group [next]](/docs/form-next-input-group--documentatie)
