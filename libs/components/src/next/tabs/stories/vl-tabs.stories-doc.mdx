...
<VluxMetaData id="components-next-tabs-tabs" />

Gebruik de `tabs-next` component om gerelateerde informatie op te splitsen in kleinere stukken content.
