...
export const tabsNextArgTypes: ArgTypes<typeof tabsNextArgs> = {
    ...defaultArgTypes(),
    activeTab: {
        name: 'active-tab',
        ...
        table: {
            ...
            defaultValue: { summary: tabsNextArgs.activeTab },
        },
    },
    alt: {
        name: 'alt',
        ...
        table: {
            ...
            category: CATEGORIES.ATTRIBUTES,
            defaultValue: { summary: tabsNextArgs.alt },
        },
    },
    disableLinks: {
        name: 'disable-links',
        ...
        table: {
            type: { summary: TYPES.BOOLEAN },
            category: CATEGORIES.ATTRIBUTES,
            defaultValue: { summary: tabsNextArgs.disableLinks },
        },
    },
    responsiveLabel: {
        ...
        table: {
            type: { summary: TYPES.STRING },
            category: CATEGORIES.ATTRIBUTES,
            defaultValue: { summary: tabsNextArgs.responsiveLabel },
        },
    },
    displayStyle: {
        name: 'display-style',
        ...
        table: {
            ...
            category: CATEGORIES.ATTRIBUTES,
            defaultValue: { summary: tabsNextArgs.displayStyle },
        },
    },
    onChangeActiveTab: {
        name: 'change',
