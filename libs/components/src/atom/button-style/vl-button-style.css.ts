...
export const vlButtonElements = ['button', 'a'] as const;
export type VlButtonElementType = (typeof vlButtonElements)[number];
...
export const vlButtonStyles = (element: VlButtonElementType = 'button', selector = ''): CSSResult => {
    ...
    return css`
        ...
        ${unsafeCSS(`${element}${selector}`)} {
            ...
            @media screen and (max-width: ${vlMediaScreenSmall}px) {
                ...
                /* ${unsafeCSS(element === 'a' ? 'min-height: 2rem' : '')}; */
            }
