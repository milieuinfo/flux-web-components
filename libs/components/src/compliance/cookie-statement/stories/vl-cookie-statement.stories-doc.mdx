...
<FluxComponentMetaData id="components-compliance-cookie-statement" />
...
- of een [vl-functional-header](/docs/components-block-functional-header--functional-header-default) met andere opties dan de standaard `functional-header` van dit component.
