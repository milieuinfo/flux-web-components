...
# Digitaal Vlaanderen Header Next

<VluxMetaData id="sections-next-header" />

<vl-alert data-vl-icon="warning" data-vl-type="success" data-vl-title="Global Header Digitaal Vlaanderen - v5 versie">
    Deze **vl-header-next** is een wrapper rond de
    [v5 global header](https://vlaamseoverheid.atlassian.net/wiki/spaces/IKPubliek/pages/7483719739/Global+header+v5)
...
```js
import { VlHeader } from '@domg-wc/sections/next/header';
```
