...
describe('cypress-component - common - format utilities (nl-BE) - formatNumber', () => {
...
describe('cypress-component - common - format utilities (nl-BE) - formatCurrency', () => {
...
describe('cypress-component - common - format utilities (nl-BE) - formatDate', () => {
...
describe('cypress-component - common - format utilities (nl-BE) - formatTime', () => {
...
describe('cypress-component - common - format utilities (nl-BE) - formatReadableDate', () => {
...
describe('cypress-component - common - format utilities (nl-BE) - formatDaysFromNow', () => {
...
describe('cypress-component - common - format utilities (nl-BE) - formatPercentage', () => {
