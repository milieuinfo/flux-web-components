            ...
            stages {
                ...
                stage('build-en-tests') {
                    parallel {
                        ...
                        stage('tests-1-components-elements') {
                        ...
                        // script controleert ook of de shards samen nog alle specs dekken. Elke shard start storybook
                        // zelf: dat gebeurt parallel en kost dus geen extra doorlooptijd.
                        stage('e2e-storybook-1-components-ontwerp-styles') {
                            // haal dit uit commentaar om deze test stage tijdelijk over te slagen
                            // beforeAgent: anders wordt de pod toch opgestart.
                            // when {
                            //    beforeAgent true
                        ...
                        stage('e2e-storybook-2-elements-form-map-sections') {
                            // haal dit uit commentaar om deze test stage tijdelijk over te slagen
                            // beforeAgent: anders wordt de pod toch opgestart.
                            // when {
                            //    beforeAgent true
