            ...
            stages {
                ...
                stage('Build + Tests') {
                    parallel {
                        ...
                        // daarnaast: jest en de integrator e2e, en daarom minder component-specs.
                        stage('component tests: components, elements') {
                        ...
                        stage('component tests: map, sections') {
                            // beforeAgent: anders wordt de pod toch opgestart voor een stage die niets doet.
                            when {
                                beforeAgent true
                                expression { runTests() }
                        ...
                        stage('component tests: common, form, integration + jest + integrator-e2e') {
                            // beforeAgent: anders wordt de pod toch opgestart voor een stage die niets doet.
                            when {
                                beforeAgent true
                                expression { runTests() }
                        ...
                        // controleert ook of de shards samen nog alle specs dekken. Elke shard start storybook zelf:
                        // dat gebeurt parallel en kost dus geen extra doorlooptijd.
                        stage('storybook-e2e tests: components, ontwerp, styles') {
                            // beforeAgent: anders wordt de pod toch opgestart voor een stage die niets doet.
                            when {
                                beforeAgent true
                                expression { runTests() }
                        ...
                        stage('storybook-e2e tests: elements, form, map, sections') {
                            // beforeAgent: anders wordt de pod toch opgestart voor een stage die niets doet.
                            when {
                                beforeAgent true
                                expression { runTests() }
                ...
                // Het onderstaande script beslist zelf of het effectief loopt op basis van de branch naam. De
