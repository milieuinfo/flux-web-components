...
De `data-vl-is-stacked...` attributen op `vl-grid` kunnen vervangen worden door de stacked classes: `vl-stacked-...`. Zie [Stacked](/docs/styles-layout-stacked--documentatie).

Check voor meer informatie de [vl-grid documentatie](/docs/styles-layout-grid--documentatie).
