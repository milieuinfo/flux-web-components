...
Onder [https://git.omgeving.vlaanderen.be/git/uig/flux-starter-app](https://git.omgeving.vlaanderen.be/git/uig/flux-starter-app)
...
Het is geen verplichting [TypeScript](https://www.typescriptlang.org/) te gebruiken, om de codekwaliteit te
verhogen raden we het wel aan.
