...
'flux-cdn-assets voorzien met tinyMCE theming en publiceren op artifactory' dan gebeurt dat in een branch met bvb. de
...
Artefacts worden enkel gebouwd voor de develop en release branches.
