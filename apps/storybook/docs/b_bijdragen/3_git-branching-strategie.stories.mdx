...
De ontwikkeling gebeurt in [git](https://git-scm.com/) op [GitHub](https://github.com/milieuinfo/uigov-web-components).
...
__feature/JIRA-123-sleutel-woorden__. Als het Flux team bvb. ticket FLUX-2322 opneemt met als titel
'cdn-assets voorzien met tinyMCE theming en publiceren op artifactory' dan gebeurt dat in een branch met bvb. de
naam __feature/FLUX-2322-tinymce-cdn__. De feature branch is tijdelijk en bij voorkeur / meestal enkel voor eigen
