...
automatisch uit, ook de transitieve. Dat is een risico voor supply-chain-aanvallen: een gecompromitteerde package
voert kwaadaardige code uit tijdens het installeren. Pnpm draait die scripts standaard niet. Enkel packages die in
...
hebt opgenomen, werkt onder pnpm niet meer. Bij npm werkt dat vaak toevallig wel, waardoor zulke verborgen
afhankelijkheden onopgemerkt blijven.
