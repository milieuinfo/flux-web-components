...
import storybookVoorbeeld from '../../resources/bijdragen/storybook-voorbeeld.ts?raw';
...
-   [ArgTypes](#argtypes)
-   [Docs](#docs)
-   [Storybook lokaal opstarten](#storybook-lokaal-opstarten)
...
**VlProgressIndicator**, **VlFunctionalHeader**, **VlAccessibility** of **VlHeader**.
...
- **[component].stories-arg.ts**: de [Args](#args) en [ArgTypes](#argtypes) gebruikt in de stories - die de
...
- de naamgeving volgt de conventie: **`[Component]+[Variant]`**, bv. `ProgressIndicatorDefault`
...
```ts
export const ProgressIndicatorDefault = Template.bind({}); // template om te gebruiken voor deze story
...
## Storybook lokaal opstarten

Voer onderstaande script uit om Storybook lokaal op te starten op http://localhost:8080:
