...
import popoverMenuSource from '../../../../../../../libs/integrations/src/popover/menu/vl-popover-menu.component?raw';
...
<Canvas of={popoverMenuStories.PopoverMenu} sourceState='none' />

<details open>
    <summary>Code</summary>
    <Source code={popoverMenuSource} language="ts" dark={true} />
</details>
