...
import * as popoverMenuInfoTileStories from './popover-info-tile-met-menu.stories';
...
<Canvas of={popoverMenuInfoTileStories.PopoverInfoTileMetMenu} sourceState="none" />
