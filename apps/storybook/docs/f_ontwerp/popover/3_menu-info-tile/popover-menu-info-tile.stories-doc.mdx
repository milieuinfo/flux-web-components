...
import menuInfoTileSource from '!!raw-loader!../../../../../../libs/integration/src/popover/menu-info-tile/vl-popover-menu-info-tile.component';
...
-   Interactie: gebruikers kunnen op de titel klikken om de info tile uit- of in te klappen, indien deze het attribuut `data-vl-toggleable` heeft.
