...
Die foutmeldingen worden getoond door de [`vl-error-message` component](/docs/form-error-message--documentatie) die de `ValidityState` van de form control controleert.
...
- een `for` attribuut toevoegen aan de `vl-error-message` component. Dit attribuut moet overeenkomen met de `id` van de form control.
- het attribuut `state` instellen op de `vl-error-message` component. Dit attribuut moet overeenkomen met de naam van de eigenschap van de `ValidityState` die je wil controleren.

Vervolgens zal de `vl-error-message` component de foutmelding tonen die is ingesteld voor de `ValidityState` van de form control wanneer gevalideerd wordt.
...
Een veld met een ontbrekende waarde zal een foutmelding tonen die is ingesteld met de `vl-error-message` component waarvan de `for` eigenschap overeenkomt met de `id` van de form control.
...
- [vl-input-field](/docs/form-input-field--documentatie)
- [vl-input-field-masked](/docs/form-input-field-masked--documentatie)
- [vl-textarea](/docs/form-textarea--documentatie)
- [vl-textarea-rich](/docs/form-textarea-rich--documentatie)
- [vl-datepicker](/docs/form-datepicker--documentatie)
- [vl-select-rich](/docs/form-select-rich--documentatie)
- [vl-select](/docs/form-select--documentatie)
- [vl-radio-group](/docs/form-radio-group--documentatie)
- [vl-upload](/docs/form-upload--documentatie)
- [vl-checkbox](/docs/form-checkbox--documentatie)
