...
Die foutmeldingen worden getoond door de [`vl-form-message` component](/docs/components-form-form-message--documentatie) die de `ValidityState` van de form control controleert.
...
<Canvas of={formValidationStories.ValidationRequired} sourceState={"shown"}/>
...
<Canvas of={formValidationStories.ValidationPattern} sourceState={"shown"}/>
