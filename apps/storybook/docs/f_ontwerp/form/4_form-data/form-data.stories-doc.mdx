...
setFormData(formElement, {
    ...
    waarheidsgetrouw: "spreekt-de-waarheid"
});
```
...
Meer info vind je bij de [Checkbox Documentatie - FormData](?path=/docs/form-next-checkbox--documentatie#formdata).

### Voorbeeld

Dit component toont een formulier met verschillende types van form controls. Het formulier kan worden ingevuld en de data kan worden opgehaald.
- De data kan worden opgehaald met de "Verstuur" knop.
- De data kan worden ingesteld met de "Set Form Data" knop.
