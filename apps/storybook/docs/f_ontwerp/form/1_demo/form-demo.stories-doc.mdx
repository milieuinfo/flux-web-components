...
- Button: `vl-button-next` component - [documentatie](/docs/components-next-button--documentatie)

## Grid

Maak voor het opbouwen van de grid structuur gebruik van de [vl-grid-next classes](/docs/styles-next-layout-afnemers-grid--documentatie).<br/>
