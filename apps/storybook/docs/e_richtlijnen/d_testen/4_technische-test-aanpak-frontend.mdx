...
<Meta title="Richtlijnen/Testen/Technische Test Aanpak Frontend"/>
...
Bij een SPA is het echter minder eenduidig wat er in de DOM gebeurt, zie hiervoor de uitgebreidere uitleg m.b.t.
[eenduidigheid](/docs/richtlijnen-testen-selenium-en-cypress--documentatie#eenduidigheid).
