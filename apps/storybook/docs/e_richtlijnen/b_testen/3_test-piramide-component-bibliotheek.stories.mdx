...
<Meta title="Richtlijnen/Testen/Test Piramide Component Bibliotheek"/>

# Test Piramide Component Bibliotheek

## Inleiding

Het Flux-team bouwt een component bibliotheek, dit is verschillend van een eindtoepassing. Om die componenten afgebakend
