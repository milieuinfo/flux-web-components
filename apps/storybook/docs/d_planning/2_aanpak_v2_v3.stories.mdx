...
- [Waarom v2](#waarom-v2)
- [Waarom Next Componenten](#waarom-componenten)
...
moeten als een uitbreiding op een native button geïmplementeerd worden. De UIG web component moet dus extenden van
...
een nieuwe tag door deze te suffixen met ''.
...
geïmplementeerde 'next' componenten kunnen nog wijzigen daar ze niet finaal zijn. De bestaande componenten blijven
...
- als er een oude en een nieuwe variant is van dezelfde component wordt de oude geschrapt en bij de nieuwe wordt
  de `` suffix verwijderd - de nieuwe vervangt dus de oude; hierdoor is de component niet backwards
  compatibel
