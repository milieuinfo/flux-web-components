...
```
import '@domg-wc/components/block/button';
```
...
registratie gebeuren onafhankelijk van de manier van importeren, zolang de code maar niet
[ge-tree-shaked](/docs/recepten-tree-shaking--documentatie) wordt!

```
let VlAccordionComponent = class VlAccordionComponent extends BaseHTMLElement {
 ...
};
