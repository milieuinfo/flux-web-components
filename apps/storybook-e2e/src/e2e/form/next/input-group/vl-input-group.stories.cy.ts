describe('story vl-input-group', () => {
    it('should contain an input-group with button on the left', () => {
        cy.visit('http://localhost:8080/iframe.html?id=form-input-group--input-group-button-left&viewMode=story');
        cy.get('.vl-group')
    ...
    it('should contain an input-group with button on the right', () => {
        cy.visit('http://localhost:8080/iframe.html?id=form-input-group--input-group-button-right&viewMode=story');
        cy.get('.vl-group')
            .should('have.class', 'vl-group--input-group')
            .children()
            .first()
    ...
    it('should contain an input-group with icon on the left', () => {
        cy.visit('http://localhost:8080/iframe.html?id=form-input-group--input-group-icon-left&viewMode=story');
    ...
    it('should contain an input-group with icon on the right', () => {
        cy.visit('http://localhost:8080/iframe.html?id=form-input-group--input-group-icon-right&viewMode=story');
        cy.get('.vl-group')
            .should('have.class', 'vl-group--input-group')
            .children()
            .eq(1) // second child
