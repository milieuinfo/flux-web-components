const inputFieldMaskedNextIbanUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-iban&viewMode=story';
const inputFieldMaskedNextRrnUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-rrn&viewMode=story';
const inputFieldMaskedNextUuidUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-uuid&viewMode=story';
const inputFieldMaskedNextDateUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-date&viewMode=story';
const inputFieldMaskedNextNumericalUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-numerical&viewMode=story';
const inputFieldMaskedNextPriceUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-price&viewMode=story';
const inputFieldMaskedNextPhoneUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-phone&viewMode=story';
const inputFieldMaskedNextPhoneInternationalUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-phone-international&viewMode=story';
const inputFieldMaskedNextMobileUrl =
    'http://localhost:8080/iframe.html?id=form-input-field-masked--input-field-masked-mobile&viewMode=story';
