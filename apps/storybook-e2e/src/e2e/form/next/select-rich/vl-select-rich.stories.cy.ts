const selectRichNextDefaultUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-default&viewMode=story';

const selectRichNextSearchUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-search&viewMode=story';

const selectRichNextNotDeletableUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-not-deletable&viewMode=story';

const selectRichNextGroupsUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-groups&viewMode=story';

const selectRichNextMultipleUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-multiple&viewMode=story';

const selectRichNextSelectedOptionUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-selected-option&viewMode=story';

const selectRichNextDisabledOptionUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-disabled-option&viewMode=story';

const selectRichNextReadOnlyUrl =
    'http://localhost:8080/iframe.html?id=form-select-rich--select-rich-read-only&viewMode=story';
