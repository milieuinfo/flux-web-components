const propertiesDefaultUrl =
    'http://localhost:8080/iframe.html?args=&id=components-properties--properties-default&viewMode=story';
const propertiesWithPropsUrl =
    'http://localhost:8080/iframe.html?args=&id=components-properties--properties-with-props&viewMode=story';
const propertiesHtmlEnrichedUrl =
    'http://localhost:8080/iframe.html?args=&id=components-properties--properties-html-enriched&viewMode=story';
const propertiesCollapsedUrl =
    'http://localhost:8080/iframe.html?args=&id=components-properties--properties-collapsed&viewMode=story';
const propertiesColumnsUrl =
    'http://localhost:8080/iframe.html?args=&id=components-properties--properties-columns&viewMode=story';
