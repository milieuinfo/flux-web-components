const tabsNextUrl = 'http://localhost:8080/iframe.html?args=&id=components-tabs-tabs--tabs-default&viewMode=story';
...
const tabsNextDynamicUrl =
    'http://localhost:8080/iframe.html?args=&id=components-tabs-tabs--tabs-dynamic&viewMode=story';
