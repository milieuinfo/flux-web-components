const paragraphNextDefaultUrl =
    'http://localhost:8080/iframe.html?id=components-paragraph--paragraph-default&viewMode=story';
const paragraphNextBoldUrl = 'http://localhost:8080/iframe.html?id=components-paragraph--paragraph-bold&viewMode=story';
const paragraphNextIntroductionUrl =
    'http://localhost:8080/iframe.html?id=components-paragraph--paragraph-introduction&viewMode=story';
