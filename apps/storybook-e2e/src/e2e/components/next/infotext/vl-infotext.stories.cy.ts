const infotextNextDefaultUrl =
    'http://localhost:8080/iframe.html?id=components-infotext--infotext-default&viewMode=story';
const infotextNextSecondaryUrl =
    'http://localhost:8080/iframe.html?id=components-infotext--infotext-badge&viewMode=story';
const infotextNextTertiaryUrl =
    'http://localhost:8080/iframe.html?id=components-infotext--infotext-link&viewMode=story';
