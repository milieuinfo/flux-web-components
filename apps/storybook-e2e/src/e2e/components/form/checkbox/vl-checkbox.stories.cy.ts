const checkboxDefaultUrl = 'http://localhost:8080/iframe.html?id=components-form-checkbox--checkbox-default&viewMode=story&args=';
const checkboxSwitchUrl = 'http://localhost:8080/iframe.html?id=components-form-checkbox--checkbox-switch&viewMode=story&args=';
const checkboxValueUrl = 'http://localhost:8080/iframe.html?id=components-form-checkbox--checkbox-value&viewMode=story&args=';
