...
import { VlCompositeInputComponent, CompositeValues } from '@domg-wc/components/form/next';
    ...
    render() {
        return html`
            <section class="vl-section" style="padding: 2rem; display:flex; flex-direction:column; gap:2rem;">
                <div>
                    <h2 class="vl-h2">vl-composite-input-next — slotted, generiek (0-100)</h2>
                    <p>
                ...
                <div>
                    <h2 class="vl-h2">vl-composite-input-next — slotted, custom validator (België)</h2>
                    <p>
